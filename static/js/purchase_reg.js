      ...
      newField.classList.add('field-group');
          newField.innerHTML = `
            ...
            <div class="field">
                ...
                <input type="text" name="rate[]" id="Rate" placeholder="Enter Rate *" required pattern="[0-9.]+">
            </div>
            ...
            <div class="field">
                ...
                <input type="text" name="MRP[]" id="MRP" placeholder="Enter MRP *" required pattern="[0-9.]+">
            </div>
